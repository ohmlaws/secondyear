...
description: Welcome to the 2nd Year Guide & Study Materials section. Here you will find helpful instructions on how to use this site, along with a complete list of all 2nd-year posts and study content.
...
> If the Download button is missing (wait for 5 seconds), the app is either installed or unsupported by your browser.
{: .prompt-warning }
